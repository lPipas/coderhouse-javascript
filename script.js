...
localStorage.setItem('dolar', 280);
let dolar = localStorage.getItem("dolar"); // VALOR DOLAR
document.querySelector('#mensaje').innerHTML = `Dolar: ${dolar}`
...
function cuentaTelasSoldables() {
    ...
    if (alto >= 400 &&
        ...
        document.querySelector('#mensaje').innerHTML = `Dolar: ${dolar} - Medidas fuera de lo posible`;
    }
}
